...
**Field Name**: Curator — Named Party
**What to Collect / Question to Answer**: Name the party that sets and monitors the on-chain vault's risk parameters in this vault's stack. If the role exists in the structure but is undisclosed, record it as gapped; if no such role exists in this structure, record N/A with the reason.
...
**Institutional Standard**: The party filling this role is named to a verifiable entity, or the role is explicitly recorded as gapped or N/A — never a silent absence. Detail: F-CUR-001 (Curator Name) and the F-CUR field set.
...
**Source / Precedent**: role-registry-reconciliation 2026-07-08: exists as F-CUR-001, retained; kept distinct from the Risk Control Operator (F-ROL-001).
