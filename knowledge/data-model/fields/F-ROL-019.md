...
**Sub-Category**: Capital & Governance
**Field Name**: Seed / Anchor Allocator — Named Party
**What to Collect / Question to Answer**: Name the party that provided the seed or anchor capital and holds a concentrated position in the vault in this vault's stack. If the role exists in the structure but is undisclosed, record it as gapped; if no such role exists in this structure, record N/A with the reason.
...
**Institutional Standard**: The party filling this role is named to a verifiable entity, or the role is explicitly recorded as gapped or N/A — never a silent absence. Holder concentration is measured in F-FIN-084; the seed/anchor role had no identification field.
...
**Source / Precedent**: role-registry-reconciliation 2026-07-08: the seed/anchor allocator (e.g. a tokenized CLO fund's a seed/anchor allocator) was unnamed as a role despite driving concentration and second-order risk.
**Criterion ID(s)**: 17.4 (P17 Counterparty & Role Registry)
