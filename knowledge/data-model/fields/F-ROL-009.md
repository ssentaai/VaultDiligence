...
**Field Name**: Administrator / NAV Agent — Named Party
**What to Collect / Question to Answer**: Name the party that administers the fund and calculates NAV in this vault's stack. If the role exists in the structure but is undisclosed, record it as gapped; if no such role exists in this structure, record N/A with the reason.
...
**Institutional Standard**: The party filling this role is named to a verifiable entity, or the role is explicitly recorded as gapped or N/A — never a silent absence. Detail: F-ENT-050 (Entity Name + NAV Calc Frequency), F-ENT-051 (Independent NAV Calculation Agent).
...
**Source / Precedent**: role-registry-reconciliation 2026-07-08: exists as F-ENT-050/051, retained.
