...
**Field Name**: RPC / Data Provider — Named Party
**What to Collect / Question to Answer**: Name the party that provides the RPC endpoints and off-chain data the vault and its monitoring depend on in this vault's stack. If the role exists in the structure but is undisclosed, record it as gapped; if no such role exists in this structure, record N/A with the reason.
...
**Institutional Standard**: The party filling this role is named to a verifiable entity, or the role is explicitly recorded as gapped or N/A — never a silent absence. RPC diversity is assessed in F-CHN-008; the provider party had no identification field.
...
**Source / Precedent**: role-registry-reconciliation 2026-07-08: RPC/data providers are referenced in several fields but never named as a party — a missing role.
