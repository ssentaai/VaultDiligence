...
**Field Name**: Governance Body — Named Party
**What to Collect / Question to Answer**: Name the party that governs the vault — the DAO, Risk Committee, or Board with authority over parameters and material change in this vault's stack. If the role exists in the structure but is undisclosed, record it as gapped; if no such role exists in this structure, record N/A with the reason.
...
**Institutional Standard**: The party filling this role is named to a verifiable entity, or the role is explicitly recorded as gapped or N/A — never a silent absence. Detail: F-GOV-022 (Board Composition), F-GOV-020 (COI).
...
**Source / Precedent**: role-registry-reconciliation 2026-07-08: governance is assessed (F-GOV-022) but the governing body was not named as its own role.
