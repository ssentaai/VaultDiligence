...
**Field Name**: Oracle Provider — Named Party
**What to Collect / Question to Answer**: Name the party that supplies the price and/or NAV feed the vault consumes in this vault's stack. If the role exists in the structure but is undisclosed, record it as gapped; if no such role exists in this structure, record N/A with the reason.
...
**Institutional Standard**: The party filling this role is named to a verifiable entity, or the role is explicitly recorded as gapped or N/A — never a silent absence. Detail: F-ORC-002 (Primary Oracle Provider(s)) and the F-ORC field set.
...
**Source / Precedent**: role-registry-reconciliation 2026-07-08: exists as F-ORC-002, retained.
